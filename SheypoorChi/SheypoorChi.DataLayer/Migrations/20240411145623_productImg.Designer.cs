...
namespace SheypoorChi.DataLayer.Migrations
{
    ...
    [Migration("20240411145623_productImg")]
            ...
            modelBuilder.Entity("SheypoorChi.DataLayer.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("19e81c35-b8a7-47d8-afc4-89fbd5e02de2"),
                            RoleName = "admin",
                            RoleTitle = "مدیر"
                        });
                });
            ...
            modelBuilder.Entity("SheypoorChi.DataLayer.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7155ccbf-9dab-4112-bbac-9680b89bc802"),
                            IsActive = true,
                            RoleId = new Guid("19e81c35-b8a7-47d8-afc4-89fbd5e02de2"),
