...
namespace SheypoorChi.DataLayer.Migrations
{
    ...
    [Migration("20240411150608_productForeignkey")]
            ...
            modelBuilder.Entity("SheypoorChi.DataLayer.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("150f4ee3-70a8-4811-8ef6-6b7b5f791587"),
                            RoleName = "admin",
                            RoleTitle = "مدیر"
                        });
                });
            ...
            modelBuilder.Entity("SheypoorChi.DataLayer.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d69cc7ff-b3f1-4c17-b3d2-abf1db2ec333"),
                            IsActive = true,
                            RoleId = new Guid("150f4ee3-70a8-4811-8ef6-6b7b5f791587"),
